'use strict';
/**
 * bio_1_1_data.js — Sub-strand data for universal generator
 * Auto-extracted from biology_1_1_introduction.js
 * Run: node generators/generate.js bio_1_1
 */

const META = {
  subject: 'Biology',
  grade: 10,
  outputDir: 'Grade 10 Bio/Bio 1.1',
...
const LESSONS = [
  ...
  {
    number: 1,
    aresKeywords: 'biology living organisms scientific study Kenya',
  ...
  {
    number: 2,
    aresKeywords: 'biology branches ecology genetics zoology',
  ...
  {
    number: 3,
    aresKeywords: 'scientific method hypothesis experiment observation',
  ...
  {
    number: 4,
    aresKeywords: 'laboratory safety equipment biology practical',
  ...
  {
    number: 5,
    aresKeywords: 'biology society Kenya applications careers',
